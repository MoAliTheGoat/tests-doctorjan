  ...
  return (
    <>
      <Calendar
        ...
        className={cn("fragment font-iranSansX", {
          "custom-day-cell": customDayCell,
        })}
        {...(locale === "fa" && {
          calendar: persian,
          locale: {
        ...
        mapDays={({ date, today, isSameDate, selectedDate }) => {
          ...
          if (customDayCell && !!dayCell) {
            return {
              style: {},
              className: "fragment-day-reset-cell",
          ...
          props.className = "fragment-day-cell";

          if (isWeekend) props.className = "fragment-day-holiday-cell";

          if (isSameDate(date, today))
            props.className = "fragment-day-today-cell";
          ...
          if (
            ...
            props.className = "fragment-day-holiday-cell";
          ...
          if (
            ...
            props.className = "fragment-day-active-cell";
...
export const DatePickerMeta: CodeComponentMeta<any> = {
  ...
  importPath: "./../../../src/fragment/components/DatePicker",
  props: {
